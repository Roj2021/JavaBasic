...
public class TypeCasting_5 {
    public static void main(String[] args) {
        ...
        float
        double
        if we try to store the contents from a smaller box to a lrger box java doesn't complain because the
        content can easily fit inside the larger box if we try the other way around we get an error

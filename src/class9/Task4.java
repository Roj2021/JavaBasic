...
public class Task4 {
    public static void main(String[] args) {
        ...
        /*
        write a program that reads a range of integres
        (start and end point), provided by a user and then
        from that range prints the sum of the even and odd integers

         */
        Scanner scanner=new Scanner(System.in);
        System.out.println("Please enter two Numbers strting point and ending point");
        ...
        for(int i = start; i <= end; i++){
            if(i%2==0) {
                ...
                oddSum=oddSum+i; // can also be written like this oddSum
